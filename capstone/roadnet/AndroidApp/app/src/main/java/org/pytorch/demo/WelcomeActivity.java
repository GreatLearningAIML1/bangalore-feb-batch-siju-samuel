...
//          R.string.welcome_page_nlp_description)
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    findViewById(R.id.skip_button).setOnClickListener(v -> {
      final Intent intent = new Intent(WelcomeActivity.this, ImageClassificationActivity.class);
      intent.putExtra(ImageClassificationActivity.INTENT_MODULE_ASSET_NAME, "roadnet_256_512.pt");
